...
+ Все картинки, полученные от разных пользователей обрабатывает **YoloWrapper**. Мы используем **Mutex**, чтобы предотвратить одновременный доступ к **YoloWrapper** со стороны нескольких сущностей
...
+ Бот получает этот словарь и выполняет указанные сервером нажатия. Таким образом и проходится капча
